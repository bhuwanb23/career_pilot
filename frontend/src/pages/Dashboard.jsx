    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-1 text-sm text-gray-500">Welcome to CareerPilot AI</p>

          {/* Stats cards */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
            {[
              { label: "Applications", value: "0", color: "from-brand-500 to-brand-600" },
              { label: "Interviews", value: "0", color: "from-emerald-500 to-emerald-600" },
              { label: "Match Score", value: "--", color: "from-amber-500 to-amber-600" },
            ].map((stat) => (
              <div key={stat.label} className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${stat.color} flex items-center justify-center mb-4`}>
                  <span className="text-white text-lg font-bold">{stat.value === "--" ? "%" : stat.value === "0" ? "0" : stat.value}</span>
                </div>
          ...
          {/* Empty state */}
          <div className="mt-12 bg-white rounded-2xl border border-gray-100 p-12 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-500 max-w-sm mx-auto">
              Upload your resume and start analyzing job applications. Your AI copilot is ready to help.
            </p>
          </div>
        </div>
      </main>
