const priorityConfig = {
  ...
  low: { bg: "bg-gray-50", text: "text-gray-500", border: "border-gray-100/50", label: "Low" },
};
        ...
        {suggestions.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-xs text-gray-600 leading-relaxed flex-1 group-hover:text-gray-900 transition-colors">
                {s.text}
              </p>
