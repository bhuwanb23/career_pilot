...
const actions = [
  ...
  },
  {
    ...
    icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0Z" /></svg>,
  },
];
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {actions.map((a) => (
          <button
            ...
            className={`py-3 px-4 rounded-xl bg-gradient-to-r ${a.color} text-white text-xs font-semibold transition-all shadow-sm hover:shadow-md active:scale-[0.98] flex flex-col items-center gap-2`}
          >
            {a.icon}
            <span>{clicked === a.label ? "Done!" : a.label}</span>
          </button>
        ))}
      </div>
    </div>
