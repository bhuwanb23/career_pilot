const data = [
  { company: "Google", value: 5 },
  { company: "Meta", value: 4 },
  { company: "Amazon", value: 3 },
  { company: "Apple", value: 2 },
  { company: "Netflix", value: 1 },
];
      ...
      <div className="space-y-3">
        {data.map((d, i) => (
          <div key={i} className="flex items-center gap-3">
            <span className="text-xs text-gray-500 w-16 text-right font-medium">{d.company}</span>
