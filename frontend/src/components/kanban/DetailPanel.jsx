        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">{new Date(application.created_at).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })}</p>
                </div>
                {application.url && (
                  <div>
                    <label className="block text-[10px] font-medium text-gray-400 uppercase tracking-wider mb-1">Link</label>
                    <a href={application.url} target="_blank" rel="noopener noreferrer" className="text-sm text-brand-600 hover:underline truncate block">View posting</a>
                  </div>
                )}
              </div>
              <div>
              ...
              {application.match_analysis && (
                <div>
                  ...
                  <div className="p-3 rounded-xl bg-gray-50 text-xs text-gray-600 leading-relaxed">{application.match_analysis}</div>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === "jd" && (
            <div>
              ...
              <div className="p-4 rounded-xl bg-gray-50 text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">{application.job_description || "No job description available."}</div>
            </div>
          )}
          ...
          {activeTab === "cover" && (
            <div>
              ...
              {application.cover_letter ? (
                <div className="p-4 rounded-xl bg-gray-50 text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">{application.cover_letter}</div>
              ) : (
          ...
          {activeTab === "messages" && (
            <div>
              ...
              {application.recruiter_msg ? (
                <div className="p-4 rounded-xl bg-gray-50 text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">{application.recruiter_msg}</div>
              ) : (
              ...
              {interviewPrep ? (
                ...
                <div className="text-center py-10">
                  <div className="w-14 h-14 rounded-2xl bg-brand-50 flex items-center justify-center mx-auto mb-3">
                    <svg className="w-7 h-7 text-brand-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}><path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342" /></svg>
                  </div>
